...
router.get('/search/:leafColors/:barkColors/:stemColors/:fruitColors/:flowerColors/:plantTypes/:plantShapes' /* /:leafDimensionsLong/:flowerDimensionsLong' */, shrub_controller.shrub_search_get);
